...
class UserAgentCreator {
    ...
    private final var lastGenerated: String?

    init {
        lastGenerated = getRandomUserAgent()
    }

    fun getLastUserAgent(): String {
        if(lastGenerated==null)
            lastGenerated = getLastUserAgent()
        return lastGenerated ?: ""
    }

    final fun getRandomUserAgent(): String {
        ...
        lastGenerated = userAgents!![floor(Math.random() * userAgents.size).toInt()]
